          ...
          <div className="grid sm: grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div
              className={`text-white flex justify-center uppercase ${
                orderProcess === "pending" ? "animate-pulse" : ""
              }`}
            >
              <div>
                <span
                  className={`mb-1 flex justify-center ${
                    orderProcess === "pending" ? "hidden" : ""
                  }`}
                >
                ...
                <p
                  className={`btn-xs w-[60px] ms-[100px] bg-slate-800 text-white rounded-2xl mt-2 flex justify-center items-center ${
                    orderProcess === "pending" ? "visible" : "text-gray-800"
                  }`}
                >
                  step-1
                </p>
                <div
                  className={`my-[80px] flex justify-center ${
                    orderProcess === "pending" ? "visible" : "invisible"
                  }`}
                >
            ...
            <div
              className={`text-white flex justify-center uppercase ${
                orderProcess === "cooking" ? "animate-pulse" : ""
              }`}
            >
              <div>
                <span
                  className={` mb-1 flex justify-center ${
                    orderProcess === "cooking" ? "hidden" : orderProcess === "pending"?"hidden":""
                  }`}
                >
                  <MdCheckCircle size={30} className="text-green-500" />
                </span>
                <h1
                  className={`font-bold text-2xl uppercase flex justify-center ${
                    orderProcess === "cooking" ? "" : "text-gray-800"
                  }`}
                >
                  Cooking
                </h1>
                <p
                  className={`btn-xs w-[60px] ms-[100px] bg-slate-800 text-white rounded-2xl mt-2 flex items-center justify-center ${
                    orderProcess === "cooking" ? "visible" : "text-gray-800"
                  }`}
                >
                  step-2
                </p>
                <button
                  className={`ms-[108px] btn-xs text-black bg-green-500 rounded-lg font-semibold uppercase hover:bg-green-800 hover:text-white mt-5 flex items-center ${
                    orderProcess === "cooking" ? "visible" : "invisible"
                  }`}
                >
                  Shift
                </button>
            ...
            <div
              className={`text-white flex justify-center uppercase ${
                orderProcess === "on the way" ? "animate-pulse" : ""
              }`}
            >
              <div>
                <span
                  className={`flex justify-center mb-1 ${
                    orderProcess === "on the way" ? "hidden" : orderProcess === "pending" ? "hidden" :orderProcess === "cooking" ? "hidden" :""
                  }`}
                >
                  <MdCheckCircle size={30} className="text-green-500" />
                </span>
                <h1
                  className={`font-bold text-2xl uppercase flex justify-center ${
                    orderProcess === "on the way" ? "" : "text-gray-800"
                  }`}
                >
                  On the Way
                </h1>
                <p
                  className={`btn-xs w-[60px] ms-[100px] bg-slate-800 text-white rounded-2xl mt-2 flex items-center justify-center ${
                    orderProcess === "on the way" ? "visible" : "text-gray-800"
                  }`}
                >
                  step-3
                </p>
                ...
                <button
                  className={`ms-[100px] btn-xs text-black bg-blue-500 rounded-lg font-semibold uppercase hover:bg-blue-800 hover:text-white mt-5 flex items-center ${
                    orderProcess === "on the way" ? "visible" : "invisible"
                  }`}
                >
                  Invoice
                </button>
            ...
            <div
              className={`text-white flex justify-center uppercase ${
                orderProcess === "delivered" ? "animate-pulse" : ""
              }`}
            >
              <div>
                <span
                  className={`hidden mb-1 ${
                    orderProcess === "delivered" ? "hidden" : ""
                  }`}
                >
                  <MdCheckCircle size={30} className="text-green-500" />
                </span>
                <h1
                  className={`font-bold text-2xl uppercase flex justify-center ${
                    orderProcess === "delivered" ? "" : "text-gray-800"
                  }`}
                >
                  Delivered
                </h1>
                <p
                  className={`btn-xs w-[60px] ms-[100px] bg-slate-800 text-white rounded-2xl mt-2 flex items-center justify-center ${
                    orderProcess === "delivered" ? "visible" : "text-gray-800"
                  }`}
                >
                  step-4
                </p>
                <div
                  className={`my-[80px] flex justify-center ${
                    orderProcess === "delivered" ? "visible" : "invisible"
                  }`}
                >
