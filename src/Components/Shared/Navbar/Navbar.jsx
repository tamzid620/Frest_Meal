    ...
    <>
      <div className="lg:flex items-center sm:block">
        <Link to="" className=" active me-2 ">
          <li className="hover:bg-[#FFD700] bg-[#FFD700]  text-[#808080]  font-bold rounded-xl">
            <button title="Home">Home</button>
          </li>
        </Link>
        <Link to="/ordertracking" className="me-2 ">
          <li className="hover:bg-[#FFD700] bg-[#FFD700]  text-[#808080]  font-bold rounded-xl">
            <button title="Order Tracking">Order Tracking</button>
          </li>
        </Link>
        <Link to="/ordertracking" className=" ">
          <li className="lg:hidden md:hidden hover:bg-[#FFD700] bg-[#FFD700]  text-[#808080]  font-bold rounded-xl mb-5">
          ...
          <div className=" flex justify-between font-bold max-w-screen-xl pt-14">
            <div className="navbar fixed z-10 bg-black mb-10 ">
              ...
              <div className="navbar-center hidden lg:flex">
                <ul className="menu menu-horizontal px-1">{daisyApa}</ul>
              </div>
