    ...
    <div>
      ...
      <div className="flex justify-center" data-aos="zoom-in-up">
        <div className="max-w-screen-lg mx-auto ">
          {/*---------------------row -1 ---------------- */}
          <Slider className="mt-10 lg:ms-0 lg:me-0 md:ms-[150px] md:me-[150px] sm: ms-[350px] sm: me-[350px]"  {...settings0}>
            {/* food item -1 */}
            <div
              data-aos="flip-up"
          ...
          {/*---------------------row -2 ---------------- */}
          <Slider className="mt-10  lg:ms-0 lg:me-0 md:ms-[150px] md:me-[150px] sm: ms-[350px] sm: me-[350px]"  {...settings1}>
            {/* food item -4 */}
            <div
              data-aos="flip-up"
              className=" rounded-xl border-t-2 border-yellow-500 shadow-lg shadow-yellow-500 p-3 w-80 transition-transform transform hover:scale-105"
          ...
          {/*---------------------row -3 ---------------- */}
          <Slider className="mt-10  lg:ms-0 lg:me-0 md:ms-[150px] md:me-[150px] sm: ms-[350px] sm: me-[350px]"  {...settings2}>
            {/* food item -7 */}
            <div
              data-aos="flip-up"
              className=" rounded-xl border-t-2 border-yellow-500 shadow-lg shadow-yellow-500 p-3 w-80 transition-transform transform hover:scale-105"
